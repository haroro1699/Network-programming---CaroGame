        ...
        try{
            ...
            while(true)
            {
                ...
                if(ss[0].equals("2"))
                {
                    String infor;
                    String account;
                    account = "INSERT INTO `table`.`user` (`username`, `password`) VALUES (?,?)";                 
                    //insert account
                ...
                if(ss[0].equals("3")) 
                {
                    ...
                    System.out.println("Tạo server có port1: "+port+" và port2: "+port1);
                }
                
                //LOAD LIST VÀ TRỞ THÀNH CLIENT
                if(ss[0].equals("4")) 
                {
                ...
                //REMOVE TÊN SERVER SAU KHI ĐÃ ĐƯỢC CHỌN
                if(ss[0].equals("5"))
                {
                    int j = 0;
