...
public class Loginsuccess extends javax.swing.JFrame {
    ...
    private void createServerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createServerActionPerformed
       // TODO add your handling code here:
        ...
        try {
            ...
            int _portserver1 = Integer.parseInt(addr[1]);
            int _portserver2= Integer.parseInt(addr[2]);
            CaroServer CaroServer = new CaroServer(_portserver1, _portserver2, _name); 
            setVisible(false);
        } catch (IOException ex) {
            Logger.getLogger(Loginsuccess.class.getName());
        }     
    ...
    //GỌI FORM CARO CLIENT SAU KHI CHỌN ĐỐI THỦ
    private void comServerItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comServerItemStateChanged
        ...
        if(evt.getStateChange()== ItemEvent.SELECTED)
        {
            ...
            //REMOVE TÊN SERVER SAU KHI ĐƯỢC CHỌN
